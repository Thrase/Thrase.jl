...
## As a julia registered package (Coming Soon):
<!-- 
...
To run the code for <a href="https://strike.scec.org/cvws/seas/download/SEAS_BP3.pdf">BP3</a>- 30 degree dipping (thrust) fault:
